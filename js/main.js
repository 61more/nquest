document.addEventListener('DOMContentLoaded', () => {
    ...
    const items = [
        ...
        { rarity: 5, number: 9, name: 'てんしちゃんの輪っか', image: './img/てんしちゃんの輪っか.png', type: 'アイテム', description: 'これはアイテム7の説明です。' },
        { rarity: 5, number: 8, name: '特級呪物　ポリチュウ', image: './img/ポリチュウ.png', type: 'ペット', description: 'これはアイテム8の説明です。' },
        { rarity: 5, number: 7, name: '草むらから飛び出すねこ', image: './img/草むらから飛び出すねこ.png', type: 'ペット', description: 'これはアイテム9の説明です。' },
